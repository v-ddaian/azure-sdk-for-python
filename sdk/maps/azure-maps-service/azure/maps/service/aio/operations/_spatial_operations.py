...
class SpatialOperations:
    ...
    async def get_geofence(
        ...
        search_buffer: Optional[float] = 50,
    ...
    async def post_closest_point(
        ...
        **kwargs
    ) -> "_models.PostClosestPointResponse":
        """**Applies to**\ : S1 pricing tier.
    ...
    async def get_closest_point(
        ...
        number_of_closest_points: Optional[int] = None,
        **kwargs
    ) -> "_models.GetClosestPointResponse":
        """**Applies to**\ : S1 pricing tier.
    ...
    async def post_point_in_polygon(
        ...
        **kwargs
    ) -> "_models.PostPointInPolygonResponse":
        """**Applies to**\ : S1 pricing tier.
    ...
    async def get_point_in_polygon(
        ...
        lon: float,
        **kwargs
    ) -> "_models.GetPointInPolygonResponse":
        """**Applies to**\ : S1 pricing tier.
