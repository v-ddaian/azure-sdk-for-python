...
class TrafficOperations:
    """TrafficOperations async operations.
    ...
    async def get_traffic_flow_tile(
        self,
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type style: str or ~azure.maps.service.models.TrafficFlowTileStyle
    ...
    async def get_traffic_flow_segment(
        self,
        format: Union[str, "_models.TextFormat"],
        style: Union[str, "_models.TrafficFlowSegmentStyle"],
        zoom: int,
        query: str,
        unit: Optional[Union[str, "_models.SpeedUnit"]] = "KMPH",
        thickness: Optional[int] = 10,
        open_lr: Optional[bool] = False,
        **kwargs
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :param style: The style to be used to render the tile. Valid values are absolute which returns
         ...
         freeflow speeds.
        :type style: str or ~azure.maps.service.models.TrafficFlowSegmentStyle
        :param zoom: Zoom level for the desired tile. Zoom value must be in the range: 0-22
         (inclusive).
         Please see `Zoom Levels and Tile Grid <https://docs.microsoft.com/en-us/azure/location-based-
         services/zoom-levels-and-tile-grid>`_ for details.
        :type zoom: int
        :param query: Coordinates of the point close to the road segment. They have to be comma-
         separated and calculated using EPSG4326 projection.
        :type query: str
        :param unit: Unit of speed in KMPH or MPH.
        :type unit: str or ~azure.maps.service.models.SpeedUnit
        :param thickness: The value of the width of the line representing traffic. This value is a
        ...
        :rtype: ~azure.maps.service.models.TrafficFlowSegmentResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_traffic_incident_tile(
        self,
        format: Union[str, "_models.TileFormat"],
        ...
        x_tile_index: int,
        y_tile_index: int,
        traffic_state: Optional[str] = "-1",
        **kwargs
    ) -> "_models.TrafficIncidentTileResult":
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :param style: The style to be used to render the tile. This parameter is not valid when format
         is pbf.
        :type style: str or ~azure.maps.service.models.TrafficIncidentTileStyle
        :param zoom: Zoom level for the desired tile. For *raster* tiles, value must be in the range:
         0-22 (inclusive). For *vector* tiles, value must be in the range: 0-22 (inclusive).
         Please see `Zoom Levels and Tile Grid <https://docs.microsoft.com/en-us/azure/location-based-
         services/zoom-levels-and-tile-grid>`_ for details.
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TrafficIncidentTileResult, or the result of cls(response)
        :rtype: ~azure.maps.service.models.TrafficIncidentTileResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.TrafficIncidentTileResult"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        deserialized = self._deserialize('TrafficIncidentTileResult', pipeline_response)
    ...
    async def get_traffic_incident_detail(
        self,
        format: Union[str, "_models.TextFormat"],
        ...
        projection: Optional[Union[str, "_models.Enum68"]] = None,
        geometries: Optional[Union[str, "_models.IncidentGeometryType"]] = None,
        expand_cluster: Optional[bool] = False,
        original_position: Optional[bool] = False,
        **kwargs
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type style: str or ~azure.maps.service.models.TrafficIncidentDetailStyle
        ...
        :type projection: str or ~azure.maps.service.models.Enum68
        :param geometries: The type of vector geometry added to incidents (returned in the :code:`<v>`
         element of the response).
        :type geometries: str or ~azure.maps.service.models.IncidentGeometryType
        ...
        :rtype: ~azure.maps.service.models.TrafficIncidentDetailResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_traffic_incident_viewport(
        self,
        format: Union[str, "_models.TextFormat"],
        boundingbox: str,
        boundingzoom: int,
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.TrafficIncidentViewportResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
