...
class ConversionOperations:
    ...
    async def _convert_preview_initial(
        self,
        udid: str,
        input_type: Union[str, "_models.ConversionInputType"],
    ...
    async def begin_convert_preview(
        self,
        udid: str,
        input_type: Union[str, "_models.ConversionInputType"],
        description: Optional[str] = None,
        ...
        *diagnostic package* to visualize
        ...
        if cont_token is None:
            raw_result = await self._convert_preview_initial(
                udid=udid,
