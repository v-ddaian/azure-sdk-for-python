...
class RenderOperations:
    ...
    async def get_map_image(
        ...
        layer: Optional[Union[str, "_models.StaticMapLayer"]] = "basic",
        style: Optional[Union[str, "_models.MapImageStyle"]] = "main",
    ...
    async def get_map_tile(
        ...
        x_tile_index: int,
        y_tile_index: int,
        tile_size: Optional[Union[str, "_models.MapTileSize"]] = "256",
        language: Optional[str] = None,
        view: Optional[str] = None,
        **kwargs
    ) -> IO:
    ...
    async def get_copyright_caption(
        ...
        **kwargs
    ) -> "_models.CopyrightCaptionResult":
        """**Applies to**\ : S0 and S1 pricing tiers.
    ...
    async def get_copyright_from_bounding_box(
        ...
        mincoordinates: str,
        maxcoordinates: str,
        text: Optional[Union[str, "_models.Enum36"]] = None,
        **kwargs
    ) -> "_models.CopyrightBoundingResult":
        """**Applies to**\ : S0 and S1 pricing tiers.
