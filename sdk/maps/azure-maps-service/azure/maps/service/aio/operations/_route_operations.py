...
class RouteOperations:
    ...
    async def _post_route_matrix_initial(
        ...
        windingness: Optional[Union[str, "_models.Windingness"]] = "normal",
        hilliness: Optional[Union[str, "_models.Hilliness"]] = "normal",
        travel_mode: Optional[Union[str, "_models.TravelMode"]] = "car",
        avoid: Optional[Union[str, "_models.Avoid"]] = None,
        traffic: Optional[bool] = True,
        route_type: Optional[Union[str, "_models.RouteType"]] = "fastest",
    ...
    async def begin_post_route_matrix(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.maps.service.models.RouteMatrixResponse]
    ...
    async def get_route_directions(
        ...
        query: str,
        max_alternatives: Optional[int] = 0,
        alternative_type: Optional[Union[str, "_models.AlternativeRouteType"]] = "anyRoute",
        min_deviation_distance: Optional[int] = 0,
        arrive_at: Optional[datetime.datetime] = None,
        depart_at: Optional[datetime.datetime] = None,
        min_deviation_time: Optional[int] = 0,
        instructions_type: Optional[Union[str, "_models.RouteInstructionsType"]] = None,
        language: Optional[str] = None,
        compute_best_order: Optional[bool] = False,
        route_representation: Optional[Union[str, "_models.RouteRepresentation"]] = "polyline",
        compute_travel_time_for: Optional[Union[str, "_models.ComputeTravelTimeFor"]] = "none",
        ...
        vehicle_max_speed: Optional[int] = 0,
        vehicle_weight: Optional[int] = 0,
        vehicle_commercial: Optional[bool] = False,
        windingness: Optional[Union[str, "_models.Windingness"]] = "normal",
        hilliness: Optional[Union[str, "_models.Hilliness"]] = "normal",
        travel_mode: Optional[Union[str, "_models.TravelMode"]] = "car",
        avoid: Optional[Union[str, "_models.Avoid"]] = None,
        ...
        route_type: Optional[Union[str, "_models.RouteType"]] = "fastest",
        vehicle_load_type: Optional[Union[str, "_models.VehicleLoadType"]] = None,
        vehicle_engine_type: Optional[Union[str, "_models.VehicleEngineType"]] = "combustion",
    ...
    async def post_route_directions(
        ...
        format: Union[str, "_models.TextFormat"],
        query: str,
        route_directions_request_body: "_models.RouteDirectionsRequestBody",
        max_alternatives: Optional[int] = 0,
        alternative_type: Optional[Union[str, "_models.AlternativeRouteType"]] = "anyRoute",
        min_deviation_distance: Optional[int] = 0,
        min_deviation_time: Optional[int] = 0,
    ...
    async def _post_route_directions_batch_initial(
        self,
        format: Union[str, "_models.JsonFormat"],
        route_directions_batch_request_body: "_models.BatchRequestBody",
        **kwargs
