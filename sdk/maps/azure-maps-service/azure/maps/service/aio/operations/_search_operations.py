...
class SearchOperations:
    ...
    async def get_search_polygon(
        self,
        format: Union[str, "_models.JsonFormat"],
        geometries: str,
        **kwargs
    ...
    async def get_search_fuzzy(
        ...
        min_fuzzy_level: Optional[int] = 1,
        max_fuzzy_level: Optional[int] = 2,
    ...
    async def get_search_poi_category(
        self,
        format: Union[str, "_models.TextFormat"],
        query: str,
        typeahead: Optional[bool] = False,
        ...
        opening_hours: Optional[Union[str, "_models.OpeningHours"]] = None,
        **kwargs
    ) -> "_models.SearchPoiCategoryResponse":
        """**Get POI by Category**
    ...
    async def get_search_poi_category_tree_preview(
        self,
        format: Union[str, "_models.JsonFormat"],
        language: Optional[str] = None,
        **kwargs
    ) -> "_models.PoiCategoryResponse":
    ...
    async def get_search_address_reverse(
        self,
        format: Union[str, "_models.TextFormat"],
        query: str,
        language: Optional[str] = None,
        return_speed_limit: Optional[bool] = False,
        heading: Optional[float] = None,
        radius: Optional[float] = None,
        number: Optional[str] = None,
        return_road_use: Optional[bool] = False,
    ...
    async def get_search_address_reverse_cross_street(
        self,
        format: Union[str, "_models.TextFormat"],
        query: str,
        limit: Optional[int] = 10,
    ...
    async def get_search_address_structured(
        self,
        format: Union[str, "_models.TextFormat"],
        language: Optional[str] = None,
        country_code: str = "US",
        ...
        view: Optional[str] = None,
        **kwargs
    ) -> "_models.SearchAddressStructuredResponse":
    ...
    async def post_search_inside_geometry(
        self,
        query: str,
        format: Union[str, "_models.TextFormat"],
        ...
        opening_hours: Optional[Union[str, "_models.OpeningHours"]] = None,
        **kwargs
    ) -> "_models.SearchGeometryResponse":
        """**Applies to**\ : S0 and S1 pricing tiers.
    ...
    async def post_search_along_route(
        ...
        opening_hours: Optional[Union[str, "_models.OpeningHours"]] = None,
        **kwargs
    ) -> "_models.SearchAlongRouteResponse":
        """**Applies to**\ : S0 and S1 pricing tiers.
    ...
    async def _post_search_fuzzy_batch_initial(
        self,
        format: Union[str, "_models.JsonFormat"],
        search_fuzzy_batch_request_body: "_models.BatchRequestBody",
        **kwargs
    ) -> Optional["_models.BatchResponse"]:
    ...
    async def begin_post_search_fuzzy_batch(
        ...
        search_fuzzy_batch_request_body: "_models.BatchRequestBody",
        **kwargs
    ) -> AsyncLROPoller["_models.BatchResponse"]:
        ...
        *
        ...
        :return: An instance of AsyncLROPoller that returns either BatchResponse or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.maps.service.models.BatchResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token is None:
            raw_result = await self._post_search_fuzzy_batch_initial(
                format=format,
    ...
    async def begin_post_search_address_batch(
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._post_search_address_batch_initial(
                format=format,
    ...
    async def begin_post_search_address_reverse_batch(
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._post_search_address_reverse_batch_initial(
                format=format,
