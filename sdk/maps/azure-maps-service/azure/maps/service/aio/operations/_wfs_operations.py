...
class WFSOperations:
    ...
    async def get_landing_page_preview(
        self,
        datasetid: str,
        **kwargs
    ) -> "_models.Root":
    ...
    async def get_requirements_classes_preview(
        self,
        datasetid: str,
        **kwargs
    ) -> "_models.ReqClasses":
    ...
    async def collections_description_preview(
        self,
        datasetid: str,
        **kwargs
    ) -> "_models.Content":
    ...
    async def collection_description_preview(
        self,
        datasetid: str,
        collection_id: str,
        **kwargs
    ...
    async def collection_definition_preview(
        self,
        datasetid: str,
        collection_id: str,
        **kwargs
    ) -> "_models.CollectionDefinition":
        """Creator makes it possible to develop applications based on your private indoor  map data using
        Azure Maps API and SDK. The Web Feature Service (WFS) API is part of  Creator. WFS API follows
        the `Open Geospatial Consortium API standard for Features
        <http://docs.opengeospatial.org/is/17-069r3/17-069r3.html>`_ to query `Datasets
    ...
    async def get_features_preview(
        self,
        datasetid: str,
        collection_id: str,
        ...
        **kwargs
    ) -> "_models.FeatureCollectionGeoJSON":
        """Creator makes it possible to develop applications based on your private indoor  map data using
        Azure Maps API and SDK. The Web Feature Service (WFS) API is part of  Creator. WFS API follows
        the `Open Geospatial Consortium API standard for Features
        <http://docs.opengeospatial.org/is/17-069r3/17-069r3.html>`_ to query `Datasets
    ...
    async def delete_feature_preview(
        self,
        datasetid: str,
        collection_id: str,
        feature_id: str,
