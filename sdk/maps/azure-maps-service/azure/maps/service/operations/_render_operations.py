...
class RenderOperations(object):
    ...
    def get_map_image(
        self,
        format,  # type: Union[str, "_models.RasterTileFormat"]
        layer="basic",  # type: Optional[Union[str, "_models.StaticMapLayer"]]
        style="main",  # type: Optional[Union[str, "_models.MapImageStyle"]]
        zoom=12,  # type: Optional[int]
        center=None,  # type: Optional[str]
        bbox=None,  # type: Optional[str]
        height=512,  # type: Optional[int]
        width=512,  # type: Optional[int]
        ...
        *Note* : Either **center** or **bbox** parameter must be supplied to the
        ...
        :type format: str or ~azure.maps.service.models.RasterTileFormat
        :param layer: Map layer requested. If layer is set to labels or hybrid, the format should be
         png.
        :type layer: str or ~azure.maps.service.models.StaticMapLayer
        :param style: Map style to be returned. Possible values are main and dark.
        :type style: str or ~azure.maps.service.models.MapImageStyle
        ...
        api_version = "1.0"
        accept = "image/jpeg, image/png, application/json, application/xml"

        # Construct URL
        url = self.get_map_image.metadata['url']  # type: ignore
        ...
        return deserialized
    get_map_image.metadata = {'url': '/map/static/{format}'}  # type: ignore

    def get_map_tile(
        self,
        format,  # type: Union[str, "_models.TileFormat"]
        layer,  # type: Union[str, "_models.MapTileLayer"]
        style,  # type: Union[str, "_models.MapTileStyle"]
        zoom,  # type: int
        x_tile_index,  # type: int
        y_tile_index,  # type: int
        tile_size="256",  # type: Optional[Union[str, "_models.MapTileSize"]]
        language=None,  # type: Optional[str]
        view=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        Tile Grid <https://docs.microsoft.com/en-us/azure/location-based-services/zoom-levels-and-tile-
        grid>`_\ )
        ...
        **Note**\ : Weather tiles are only available via `Get Map Tile V2 API
        ...
        :type format: str or ~azure.maps.service.models.TileFormat
        :param layer: Map layer requested. Possible values are basic, hybrid, labels and terra.
        :type layer: str or ~azure.maps.service.models.MapTileLayer
        :param style: Map style to be returned. Possible values are main, dark, and shaded_relief.
        :type style: str or ~azure.maps.service.models.MapTileStyle
        ...
        :type tile_size: str or ~azure.maps.service.models.MapTileSize
        :param language: Language in which search results should be returned. Should be one of
         supported IETF language tags, case insensitive. When data in specified language is not
         available for a specific field, default language is used.
    ...
    def get_map_state_tile_preview(
        self,
        zoom,  # type: int
        x_tile_index,  # type: int
        y_tile_index,  # type: int
        ...
        **kwargs  # type: Any
        ...
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "1.0"
        accept = "application/vnd.mapbox-vector-tile, application/json, application/xml"
    ...
    def get_copyright_caption(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.CopyrightCaptionResult"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CopyrightCaptionResult, or the result of cls(response)
        :rtype: ~azure.maps.service.models.CopyrightCaptionResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CopyrightCaptionResult"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CopyrightCaptionResult', pipeline_response)
    ...
    def get_map_imagery_tile(
        self,
        format,  # type: Union[str, "_models.RasterTileFormat"]
        style,  # type: Union[str, "_models.MapImageryStyle"]
        zoom,  # type: int
        x_tile_index,  # type: int
        y_tile_index,  # type: int
        **kwargs  # type: Any
        ...
        **Note**\ : We recommend to start to use the new `Get Map Tile V2 API
        ...
        :type style: str or ~azure.maps.service.models.MapImageryStyle
    ...
    def get_copyright_from_bounding_box(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        mincoordinates,  # type: str
        maxcoordinates,  # type: str
        text=None,  # type: Optional[Union[str, "_models.Enum36"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CopyrightBoundingResult"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :param text: Yes/no value to exclude textual data from response. Only images and country names
         will be in response.
        :type text: str or ~azure.maps.service.models.Enum36
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CopyrightBoundingResult, or the result of cls(response)
        :rtype: ~azure.maps.service.models.CopyrightBoundingResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CopyrightBoundingResult"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CopyrightBoundingResult', pipeline_response)
    ...
    def get_copyright_for_tile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.CopyrightTileResult"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type text: str or ~azure.maps.service.models.Enum36
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CopyrightTileResult, or the result of cls(response)
        :rtype: ~azure.maps.service.models.CopyrightTileResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CopyrightTileResult"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CopyrightTileResult', pipeline_response)
    ...
    def get_copyright_for_world(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.CopyrightWorldResult"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type text: str or ~azure.maps.service.models.Enum36
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CopyrightWorldResult, or the result of cls(response)
        :rtype: ~azure.maps.service.models.CopyrightWorldResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CopyrightWorldResult"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CopyrightWorldResult', pipeline_response)
