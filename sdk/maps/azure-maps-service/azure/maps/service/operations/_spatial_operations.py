...
class SpatialOperations(object):
    ...
    def get_geofence(
        ...
        user_time=None,  # type: Optional[str]
        search_buffer=50,  # type: Optional[float]
        is_async=False,  # type: Optional[bool]
        ...
        **Applies to:** S1 Pricing tier.
        ...
        :type device_id: str
        :param ud_id: The unique id returned from `Data Upload API <https://docs.microsoft.com/en-
        ...
        :type mode: str or ~azure.maps.service.models.GeofenceMode
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GeofenceResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.GeofenceResponse
        ...
        query_parameters['udId'] = self._serialize.query("ud_id", ud_id, 'str')
        ...
        if user_time is not None:
            query_parameters['userTime'] = self._serialize.query("user_time", user_time, 'str')
    ...
    def post_geofence(
        ...
        **Applies to:** S1 Pricing tier.
        ...
        :type search_geofence_request_body: ~azure.maps.service.models.GeoJSONFeatureCollection
        :param z: The sea level in meter of the location being passed. If this parameter is presented,
    ...
    def post_buffer(
        ...
        **kwargs  # type: Any
        ...
        :type buffer_request_body: ~azure.maps.service.models.BufferRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BufferResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.BufferResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def post_closest_point(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.PostClosestPointResponse"
        """**Applies to**\ : S1 pricing tier.
        ...
        :type closest_point_request_body: ~azure.maps.service.models.GeoJSONFeatureCollection
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PostClosestPointResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.PostClosestPointResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PostClosestPointResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        deserialized = self._deserialize('PostClosestPointResponse', pipeline_response)
    ...
    def get_closest_point(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.GetClosestPointResponse"
        """**Applies to**\ : S1 pricing tier.
        ...
        :type number_of_closest_points: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GetClosestPointResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.GetClosestPointResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.GetClosestPointResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        deserialized = self._deserialize('GetClosestPointResponse', pipeline_response)
    ...
    def post_point_in_polygon(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.PostPointInPolygonResponse"
        """**Applies to**\ : S1 pricing tier.
        ...
        :type point_in_polygon_request_body: ~azure.maps.service.models.GeoJSONFeatureCollection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PostPointInPolygonResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.PostPointInPolygonResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PostPointInPolygonResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        deserialized = self._deserialize('PostPointInPolygonResponse', pipeline_response)
    ...
    def get_point_in_polygon(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.GetPointInPolygonResponse"
        """**Applies to**\ : S1 pricing tier.
        ...
        :type lon: float
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GetPointInPolygonResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.GetPointInPolygonResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.GetPointInPolygonResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        deserialized = self._deserialize('GetPointInPolygonResponse', pipeline_response)
    ...
    def get_great_circle_distance(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.service.models.GreatCircleDistanceResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
