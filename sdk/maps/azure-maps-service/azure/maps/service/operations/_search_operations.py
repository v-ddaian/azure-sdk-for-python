...
class SearchOperations(object):
    ...
    def get_search_polygon(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchPolygonResponse"
        """**Get Polygon**
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :rtype: ~azure.maps.service.models.SearchPolygonResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchPolygonResponse"]
        error_map = {
        ...
        # Construct URL
        url = self.get_search_polygon.metadata['url']  # type: ignore
        ...
        deserialized = self._deserialize('SearchPolygonResponse', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    get_search_polygon.metadata = {'url': '/search/polygon/{format}'}  # type: ignore

    def get_search_fuzzy(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        query,  # type: str
        typeahead=False,  # type: Optional[bool]
        limit=10,  # type: Optional[int]
        ofs=0,  # type: Optional[int]
        ...
        min_fuzzy_level=1,  # type: Optional[int]
        max_fuzzy_level=2,  # type: Optional[int]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchFuzzyResponse"
        """**Free Form Search**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type format: str or ~azure.maps.service.models.TextFormat
        ...
        :param language: Language in which search results should be returned. Should be one of
         ...
         maps/supported-languages>`_ for details.
        :type language: str
        ...
        :type idx_set: list[str or ~azure.maps.service.models.SearchIndexSet]
        ...
        :type connector_set: list[str or ~azure.maps.service.models.ConnectorSet]
        ...
        :type opening_hours: str or ~azure.maps.service.models.OpeningHours
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchFuzzyResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchFuzzyResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchFuzzyResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_fuzzy.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if typeahead is not None:
            query_parameters['typeahead'] = self._serialize.query("typeahead", typeahead, 'bool')
        if limit is not None:
            query_parameters['limit'] = self._serialize.query("limit", limit, 'int', maximum=100, minimum=1)
        if ofs is not None:
            query_parameters['ofs'] = self._serialize.query("ofs", ofs, 'int', maximum=1900, minimum=0)
        if category_set is not None:
            query_parameters['categorySet'] = self._serialize.query("category_set", category_set, '[int]', div=',')
        if country_set is not None:
            query_parameters['countrySet'] = self._serialize.query("country_set", country_set, '[str]', div=',')
        if lat is not None:
            query_parameters['lat'] = self._serialize.query("lat", lat, 'float')
        if lon is not None:
            query_parameters['lon'] = self._serialize.query("lon", lon, 'float')
        if radius is not None:
            query_parameters['radius'] = self._serialize.query("radius", radius, 'float')
        ...
        if extended_postal_codes_for is not None:
            query_parameters['extendedPostalCodesFor'] = self._serialize.query("extended_postal_codes_for", extended_postal_codes_for, 'str')
        ...
        if idx_set is not None:
            query_parameters['idxSet'] = self._serialize.query("idx_set", idx_set, '[str]', div=',')
        if brand_set is not None:
            query_parameters['brandSet'] = self._serialize.query("brand_set", brand_set, '[str]', div=',')
        if connector_set is not None:
            query_parameters['connectorSet'] = self._serialize.query("connector_set", connector_set, '[str]', div=',')
        if view is not None:
            query_parameters['view'] = self._serialize.query("view", view, 'str')
        if opening_hours is not None:
            query_parameters['openingHours'] = self._serialize.query("opening_hours", opening_hours, 'str')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchFuzzyResponse', pipeline_response)
        ...
        return deserialized
    get_search_fuzzy.metadata = {'url': '/search/fuzzy/{format}'}  # type: ignore
    ...
    def get_search_poi(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchPoiResponse"
        """**Get POI by Name**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type opening_hours: str or ~azure.maps.service.models.OpeningHours
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchPoiResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchPoiResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchPoiResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_poi.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchPoiResponse', pipeline_response)
        ...
        return deserialized
    get_search_poi.metadata = {'url': '/search/poi/{format}'}  # type: ignore
    ...
    def get_search_nearby(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchNearbyResponse"
        """**Nearby Search**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type view: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchNearbyResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchNearbyResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchNearbyResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_nearby.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchNearbyResponse', pipeline_response)
        ...
        return deserialized
    get_search_nearby.metadata = {'url': '/search/nearby/{format}'}  # type: ignore

    def get_search_poi_category(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        query,  # type: str
        typeahead=False,  # type: Optional[bool]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchPoiCategoryResponse"
        """**Get POI by Category**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type opening_hours: str or ~azure.maps.service.models.OpeningHours
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchPoiCategoryResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchPoiCategoryResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchPoiCategoryResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_poi_category.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchPoiCategoryResponse', pipeline_response)
        ...
        return deserialized
    get_search_poi_category.metadata = {'url': '/search/poi/category/{format}'}  # type: ignore
    ...
    def get_search_poi_category_tree_preview(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.PoiCategoryResponse"
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type language: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PoiCategoryResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.PoiCategoryResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PoiCategoryResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_poi_category_tree_preview.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PoiCategoryResponse', pipeline_response)
        ...
        return deserialized
    get_search_poi_category_tree_preview.metadata = {'url': '/search/poi/category/tree/{format}'}  # type: ignore
    ...
    def get_search_address(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchAddressResponse"
        """**Address Geocoding**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type view: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchAddressResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchAddressResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchAddressResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_address.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchAddressResponse', pipeline_response)
        ...
        return deserialized
    get_search_address.metadata = {'url': '/search/address/{format}'}  # type: ignore

    def get_search_address_reverse(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        query,  # type: str
        language=None,  # type: Optional[str]
        return_speed_limit=False,  # type: Optional[bool]
        heading=None,  # type: Optional[float]
        radius=None,  # type: Optional[float]
        number=None,  # type: Optional[str]
        return_road_use=False,  # type: Optional[bool]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchAddressReverseResponse"
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.SearchAddressReverseResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchAddressReverseResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_address_reverse.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if language is not None:
            query_parameters['language'] = self._serialize.query("language", language, 'str')
        if return_speed_limit is not None:
            query_parameters['returnSpeedLimit'] = self._serialize.query("return_speed_limit", return_speed_limit, 'bool')
        if heading is not None:
            query_parameters['heading'] = self._serialize.query("heading", heading, 'float', maximum=360, minimum=-360)
        if radius is not None:
            query_parameters['radius'] = self._serialize.query("radius", radius, 'float')
        if number is not None:
            query_parameters['number'] = self._serialize.query("number", number, 'str')
        if return_road_use is not None:
            query_parameters['returnRoadUse'] = self._serialize.query("return_road_use", return_road_use, 'bool')
        if road_use is not None:
            query_parameters['roadUse'] = self._serialize.query("road_use", road_use, 'str')
        ...
        if return_match_type is not None:
            query_parameters['returnMatchType'] = self._serialize.query("return_match_type", return_match_type, 'bool')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchAddressReverseResponse', pipeline_response)
        ...
        return deserialized
    get_search_address_reverse.metadata = {'url': '/search/address/reverse/{format}'}  # type: ignore

    def get_search_address_reverse_cross_street(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        query,  # type: str
        limit=10,  # type: Optional[int]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchAddressReverseCrossStreetResponse"
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.SearchAddressReverseCrossStreetResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchAddressReverseCrossStreetResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_address_reverse_cross_street.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchAddressReverseCrossStreetResponse', pipeline_response)
        ...
        return deserialized
    get_search_address_reverse_cross_street.metadata = {'url': '/search/address/reverse/crossStreet/{format}'}  # type: ignore

    def get_search_address_structured(
        self,
        format,  # type: Union[str, "_models.TextFormat"]
        language=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchAddressStructuredResponse"
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type view: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchAddressStructuredResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchAddressStructuredResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchAddressStructuredResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.get_search_address_structured.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchAddressStructuredResponse', pipeline_response)
        ...
        return deserialized
    get_search_address_structured.metadata = {'url': '/search/address/structured/{format}'}  # type: ignore

    def post_search_inside_geometry(
        self,
        query,  # type: str
        format,  # type: Union[str, "_models.TextFormat"]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchGeometryResponse"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type search_inside_geometry_request_body: ~azure.maps.service.models.SearchInsideGeometryRequestBody
        :param limit: Maximum number of responses that will be returned. Default: 10, minimum: 1 and
         maximum: 100.
        :type limit: int
        :param language: Language in which search results should be returned. Should be one of
        ...
        :type opening_hours: str or ~azure.maps.service.models.OpeningHours
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchGeometryResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchGeometryResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchGeometryResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.post_search_inside_geometry.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(search_inside_geometry_request_body, 'SearchInsideGeometryRequestBody')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchGeometryResponse', pipeline_response)
        ...
        return deserialized
    post_search_inside_geometry.metadata = {'url': '/search/geometry/{format}'}  # type: ignore

    def post_search_along_route(
        self,
        query,  # type: str
        format,  # type: Union[str, "_models.TextFormat"]
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchAlongRouteResponse"
        """**Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type search_along_route_request_body: ~azure.maps.service.models.SearchAlongRouteRequestBody
        :param category_set: A comma-separated list of category set IDs which could be used to restrict
         the result to specific Points of Interest categories. ID order does not matter. When multiple
         category identifiers are provided, only POIs that belong to (at least) one of the categories
         from the provided list will be returned. The list of supported categories can be discovered
        ...
        :type opening_hours: str or ~azure.maps.service.models.OpeningHours
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchAlongRouteResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.SearchAlongRouteResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchAlongRouteResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self.post_search_along_route.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if limit is not None:
            query_parameters['limit'] = self._serialize.query("limit", limit, 'int', maximum=20)
        if brand_set is not None:
            query_parameters['brandSet'] = self._serialize.query("brand_set", brand_set, '[str]', div=',')
        if connector_set is not None:
            query_parameters['connectorSet'] = self._serialize.query("connector_set", connector_set, '[str]', div=',')
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(search_along_route_request_body, 'SearchAlongRouteRequestBody')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SearchAlongRouteResponse', pipeline_response)
        ...
        return deserialized
    post_search_along_route.metadata = {'url': '/search/alongRoute/{format}'}  # type: ignore

    def _post_search_fuzzy_batch_initial(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        search_fuzzy_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.BatchResponse"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.BatchResponse"]]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        # Construct URL
        url = self._post_search_fuzzy_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(search_fuzzy_batch_request_body, 'BatchRequestBody')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def begin_post_search_fuzzy_batch(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        search_fuzzy_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> LROPoller["_models.BatchResponse"]
        ...
        * The number of batch items is limited to **10,000** for this API.
        ...
        .. code-block::
               ...
               GET https://atlas.microsoft.com/batch/{batch-id}?api-version=1.0&subscription-
        key={subscription-key}
        ...
        parameters <https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchfuzzy#uri-
        parameters>`_. The string values in the *search fuzzy* query must be properly escaped (e.g. "
        ...
        .. code-block::
           ...
           https://atlas.microsoft.com/batch/{batch-id}?api-version=1.0&subscription-key={subscription-
        key}
        ...
        *
          `\ ``SearchFuzzyResponse`` <https://docs.microsoft.com/en-
        us/rest/api/maps/search/getsearchfuzzy#searchfuzzyresponse>`_ - If the query completed
        successfully.
        ...
        *
        ...
        :type search_fuzzy_batch_request_body: ~azure.maps.service.models.BatchRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either BatchResponse or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.service.models.BatchResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token is None:
            raw_result = self._post_search_fuzzy_batch_initial(
                format=format,
                search_fuzzy_batch_request_body=search_fuzzy_batch_request_body,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    begin_post_search_fuzzy_batch.metadata = {'url': '/search/fuzzy/batch/{format}'}  # type: ignore

    def _post_search_address_batch_initial(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._post_search_address_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def begin_post_search_address_batch(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        search_address_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
        ...
        * The number of batch items is limited to **10,000** for this API.
        ...
        `URI parameters <https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchaddress#uri-
        ...
        *
          `\ ``SearchAddressResponse`` <https://docs.microsoft.com/en-
        us/rest/api/maps/search/getsearchaddress#searchaddressresponse>`_ - If the query completed
        successfully.
        ...
        *
        ...
        :type search_address_batch_request_body: ~azure.maps.service.models.BatchRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the LROBasePolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._post_search_address_batch_initial(
                format=format,
                search_address_batch_request_body=search_address_batch_request_body,
                cls=lambda x,y,z: x,
                **kwargs
            )
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_post_search_address_batch.metadata = {'url': '/search/address/batch/{format}'}  # type: ignore

    def _post_search_address_reverse_batch_initial(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._post_search_address_reverse_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def begin_post_search_address_reverse_batch(
        ...
        * The number of batch items is limited to **10,000** for this API.
        ...
        reverse* `URI parameters <https://docs.microsoft.com/en-
        us/rest/api/maps/search/getsearchaddressreverse#uri-parameters>`_. The string values in the
        *search address reverse* query must be properly escaped (e.g. " character should be escaped
        ...
        *
          `\ ``SearchAddressReverseResponse`` <https://docs.microsoft.com/en-
        us/rest/api/maps/search/getsearchaddressreverse#searchaddressreverseresponse>`_ - If the query
        ...
        *
        ...
        :param search_address_reverse_batch_request_body: The list of reverse geocoding
         ...
         least 1 query.
        :type search_address_reverse_batch_request_body: ~azure.maps.service.models.BatchRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the LROBasePolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._post_search_address_reverse_batch_initial(
                format=format,
                search_address_reverse_batch_request_body=search_address_reverse_batch_request_body,
                cls=lambda x,y,z: x,
                **kwargs
            )
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_post_search_address_reverse_batch.metadata = {'url': '/search/address/reverse/batch/{format}'}  # type: ignore
