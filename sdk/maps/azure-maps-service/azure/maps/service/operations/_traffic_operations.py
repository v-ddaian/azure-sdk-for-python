...
class TrafficOperations(object):
    ...
    def get_traffic_flow_tile(
        ...
        thickness=10,  # type: Optional[int]
        **kwargs  # type: Any
    ):
        # type: (...) -> IO
        """**Traffic Flow Tile**
    ...
    def get_traffic_flow_segment(
        ...
        zoom,  # type: int
        query,  # type: str
        unit="KMPH",  # type: Optional[Union[str, "_models.SpeedUnit"]]
        thickness=10,  # type: Optional[int]
        open_lr=False,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
    ...
    def get_traffic_incident_tile(
        ...
        x_tile_index,  # type: int
        y_tile_index,  # type: int
        traffic_state="-1",  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.TrafficIncidentTileResult"
    ...
    def get_traffic_incident_detail(
        ...
        projection=None,  # type: Optional[Union[str, "_models.Enum68"]]
        geometries=None,  # type: Optional[Union[str, "_models.IncidentGeometryType"]]
        expand_cluster=False,  # type: Optional[bool]
        original_position=False,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
