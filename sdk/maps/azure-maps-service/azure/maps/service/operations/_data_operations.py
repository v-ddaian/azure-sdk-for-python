...
class DataOperations(object):
    ...
    def _upload_preview_initial(
        self,
        data_format,  # type: Union[str, "_models.UploadDataFormat"]
        upload_content,  # type: object
        **kwargs  # type: Any
    ):
        ...
        error_map = {
            ...
            200: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        return deserialized
    _upload_preview_initial.metadata = {'url': '/mapData/upload'}  # type: ignore

    def begin_upload_preview(
        self,
        data_format,  # type: Union[str, "_models.UploadDataFormat"]
        upload_content,  # type: object
        **kwargs  # type: Any
        ...
        * ``application/octet-stream``
        ...
        `long-running request <https://docs.microsoft.com/azure/azure-maps/private-atlas-long-running-
        operation>`_.
        ...
        if cont_token is None:
            raw_result = self._upload_preview_initial(
    ...
    begin_upload_preview.metadata = {'url': '/mapData/upload'}  # type: ignore

    def _update_preview_initial(
        self,
        udid,  # type: str
        update_content,  # type: object
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.LongRunningOperationResult"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.LongRunningOperationResult"]]
    ...
    def begin_update_preview(
        ...
        **Applies to:** S1 pricing tier.
        ...
        <https://docs.microsoft.com/rest/api/maps/data/uploadpreview>`_\ , for
        ...
        * ``application/octet-stream``
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_preview_initial(
                udid=udid,
    ...
    def download_preview(
        ...
        **Applies to:** S1 pricing tier.
        ...
        us/rest/api/maps/data/uploadpreview>`_ for use in our `Azure Maps Geofencing Service
    ...
    def delete_preview(
        ...
        **Applies to:** S1 pricing tier.
        ...
        Upload API <https://docs.microsoft.com/en-us/rest/api/maps/data/uploadpreview>`_ for use in our
        `Azure Maps Geofencing Service <https://docs.microsoft.com/en-us/rest/api/maps/spatial>`_. You
        can also use this API to delete old/unused uploaded content and create space for new content.
    ...
    def list_preview(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.MapDataListResponse"
        """**Data List API**
        ...
        **Applies to:** S1 pricing tier.
        ...
        Upload API <https://docs.microsoft.com/en-us/rest/api/maps/data/uploadpreview>`_.
               ...
               [
                   {
                       ...
                       "location":
        "https://atlas.microsoft.com/mapData/9a1288fa-1858-4a3b-b68d-13a8j5af7d7c?api-version=1.0",
                       "sizeInBytes": 29920,
                   ...
                   },
                   {
                       ...
                       "location":
        "https://atlas.microsoft.com/mapData/8b1288fa-1958-4a2b-b68e-13a7i5af7d7c?api-version=1.0",
                       "sizeInBytes": 1339,
                       "uploadStatus": "Completed"
                   },
                   {
                       ...
                       "location":
        "https://atlas.microsoft.com/mapData/7c1288fa-2058-4a1b-b68f-13a6h5af7d7c?api-version=1.0",
                       "sizeInBytes": 1650,
        ...
        :rtype: ~azure.maps.service.models.MapDataListResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
