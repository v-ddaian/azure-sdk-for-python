...
class WeatherOperations(object):
    ...
    def get_hourly_forecast(
        ...
        query,  # type: str
        unit="metric",  # type: Optional[Union[str, "_models.Unit"]]
        duration=1,  # type: Optional[int]
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :param unit: Specifies to return the data in either metric units or imperial units. Default
         value is metric.
        :type unit: str or ~azure.maps.service.models.Unit
        ...
        :rtype: ~azure.maps.service.models.HourlyForecastResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.HourlyForecastResponse"]
        error_map = {
    ...
    def get_minute_forecast(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :rtype: ~azure.maps.service.models.MinuteForecastResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.MinuteForecastResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_quarter_day_forecast(
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.QuarterDayForecastResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.QuarterDayForecastResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_current_conditions(
        ...
        query,  # type: str
        unit="metric",  # type: Optional[Union[str, "_models.Unit"]]
        details="true",  # type: Optional[str]
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.CurrentConditionsResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CurrentConditionsResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_daily_forecast(
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.DailyForecastResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DailyForecastResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_weather_along_route(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.service.models.WeatherAlongRouteResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.WeatherAlongRouteResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_severe_weather_alerts(
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.SevereWeatherAlertsResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SevereWeatherAlertsResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
    ...
    def get_daily_indices(
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :rtype: ~azure.maps.service.models.DailyIndicesResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DailyIndicesResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
