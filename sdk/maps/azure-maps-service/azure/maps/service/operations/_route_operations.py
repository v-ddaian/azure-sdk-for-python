...
class RouteOperations(object):
    ...
    def _post_route_matrix_initial(
        ...
        route_matrix_body,  # type: "_models.RouteMatrixRequestBody"
        wait_for_results=False,  # type: Optional[bool]
        compute_travel_time_for="none",  # type: Optional[Union[str, "_models.ComputeTravelTimeFor"]]
        section_type="travelMode",  # type: Optional[Union[str, "_models.SectionType"]]
        ...
        windingness="normal",  # type: Optional[Union[str, "_models.Windingness"]]
        hilliness="normal",  # type: Optional[Union[str, "_models.Hilliness"]]
        travel_mode="car",  # type: Optional[Union[str, "_models.TravelMode"]]
        avoid=None,  # type: Optional[Union[str, "_models.Avoid"]]
        traffic=True,  # type: Optional[bool]
        route_type="fastest",  # type: Optional[Union[str, "_models.RouteType"]]
        ...
        **kwargs  # type: Any
        ...
        if avoid is not None:
            query_parameters['avoid'] = self._serialize.query("avoid", avoid, 'str')
        ...
        body_content = self._serialize.body(route_matrix_body, 'RouteMatrixRequestBody')
    ...
    def begin_post_route_matrix(
        ...
        **kwargs  # type: Any
        ...
        :param route_matrix_body: The matrix of origin and destination coordinates to compute the route
        ...
        :type route_matrix_body: ~azure.maps.service.models.RouteMatrixRequestBody
        ...
        :param compute_travel_time_for: Specifies whether to return additional travel times using
         different types of traffic information (none, historic, live) as well as the default best-
         estimate travel time.
        :type compute_travel_time_for: str or ~azure.maps.service.models.ComputeTravelTimeFor
        ...
        :type section_type: str or ~azure.maps.service.models.SectionType
        ...
        :type windingness: str or ~azure.maps.service.models.Windingness
        :param hilliness: Degree of hilliness for thrilling route. This parameter can only be used in
         conjunction with ``routeType``\ =thrilling.
        :type hilliness: str or ~azure.maps.service.models.Hilliness
        ...
        :type travel_mode: str or ~azure.maps.service.models.TravelMode
        ...
        :type avoid: str or ~azure.maps.service.models.Avoid
        ...
        :type route_type: str or ~azure.maps.service.models.RouteType
        ...
        :type vehicle_load_type: str or ~azure.maps.service.models.VehicleLoadType
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.service.models.RouteMatrixResponse]
        ...
        if cont_token is None:
            raw_result = self._post_route_matrix_initial(
                format=format,
                route_matrix_body=route_matrix_body,
    ...
    def get_route_directions(
        ...
        query,  # type: str
        max_alternatives=0,  # type: Optional[int]
        alternative_type="anyRoute",  # type: Optional[Union[str, "_models.AlternativeRouteType"]]
        min_deviation_distance=0,  # type: Optional[int]
        arrive_at=None,  # type: Optional[datetime.datetime]
        depart_at=None,  # type: Optional[datetime.datetime]
        min_deviation_time=0,  # type: Optional[int]
        instructions_type=None,  # type: Optional[Union[str, "_models.RouteInstructionsType"]]
        language=None,  # type: Optional[str]
        compute_best_order=False,  # type: Optional[bool]
        route_representation="polyline",  # type: Optional[Union[str, "_models.RouteRepresentation"]]
        compute_travel_time_for="none",  # type: Optional[Union[str, "_models.ComputeTravelTimeFor"]]
        ...
        vehicle_max_speed=0,  # type: Optional[int]
        vehicle_weight=0,  # type: Optional[int]
        vehicle_commercial=False,  # type: Optional[bool]
        windingness="normal",  # type: Optional[Union[str, "_models.Windingness"]]
        hilliness="normal",  # type: Optional[Union[str, "_models.Hilliness"]]
        travel_mode="car",  # type: Optional[Union[str, "_models.TravelMode"]]
        avoid=None,  # type: Optional[Union[str, "_models.Avoid"]]
        ...
        route_type="fastest",  # type: Optional[Union[str, "_models.RouteType"]]
        vehicle_load_type=None,  # type: Optional[Union[str, "_models.VehicleLoadType"]]
        vehicle_engine_type="combustion",  # type: Optional[Union[str, "_models.VehicleEngineType"]]
        ...
        **kwargs  # type: Any
        ...
        :type alternative_type: str or ~azure.maps.service.models.AlternativeRouteType
        ...
        :type instructions_type: str or ~azure.maps.service.models.RouteInstructionsType
        ...
        :type route_representation: str or ~azure.maps.service.models.RouteRepresentation
        :param compute_travel_time_for: Specifies whether to return additional travel times using
         different types of traffic information (none, historic, live) as well as the default best-
         estimate travel time.
        :type compute_travel_time_for: str or ~azure.maps.service.models.ComputeTravelTimeFor
        ...
        :type vehicle_engine_type: str or ~azure.maps.service.models.VehicleEngineType
        ...
        :rtype: ~azure.maps.service.models.RouteDirectionsResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def post_route_directions(
        ...
        format,  # type: Union[str, "_models.TextFormat"]
        query,  # type: str
        route_directions_request_body,  # type: "_models.RouteDirectionsRequestBody"
        max_alternatives=0,  # type: Optional[int]
        alternative_type="anyRoute",  # type: Optional[Union[str, "_models.AlternativeRouteType"]]
        min_deviation_distance=0,  # type: Optional[int]
        min_deviation_time=0,  # type: Optional[int]
        ...
        **kwargs  # type: Any
        ...
        :type query: str
        :param route_directions_request_body: Used for reconstructing a route and for calculating zero
         or more alternative routes to this reference route.  The provided sequence of coordinates is
         used as input for route reconstruction. The alternative routes  are calculated between the
         ...
         * The route must use departAt.
         * The vehicleHeading is ignored.
        :type route_directions_request_body: ~azure.maps.service.models.RouteDirectionsRequestBody
        :param max_alternatives: Number of desired alternative routes to be calculated. Default: 0,
         minimum: 0 and maximum: 5.
        :type max_alternatives: int
        :param alternative_type: Controls the optimality, with respect to the given planning criteria,
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(route_directions_request_body, 'RouteDirectionsRequestBody')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def get_route_range(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.RouteRangeResponse"
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type auxiliary_power_ink_w: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RouteRangeResponse, or the result of cls(response)
        :rtype: ~azure.maps.service.models.RouteRangeResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RouteRangeResponse"]
        error_map = {
            409: ResourceExistsError,
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
            400: lambda response: HttpResponseError(response=response, model=self._deserialize(_models.ErrorResponse, response)),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RouteRangeResponse', pipeline_response)
    ...
    def _post_route_directions_batch_initial(
        self,
        format,  # type: Union[str, "_models.JsonFormat"]
        route_directions_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
    ):
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(route_directions_batch_request_body, 'BatchRequestBody')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def begin_post_route_directions_batch(
        ...
        * The number of batch items is limited to **700** for this API.
        ...
        `URI parameters <https://docs.microsoft.com/en-us/rest/api/maps/route/getroutedirections#uri-
        ...
        *
          `\ ``RouteDirectionsResponse`` <https://docs.microsoft.com/en-
        us/rest/api/maps/route/getroutedirections#routedirectionsresponse>`_ - If the query completed
        successfully.
        ...
        *
        ...
        :param format: Desired format of the response. Only ``json`` format is supported.
        :type format: str or ~azure.maps.service.models.JsonFormat
        :param route_directions_batch_request_body: The list of route directions queries/requests to
        ...
        :type route_directions_batch_request_body: ~azure.maps.service.models.BatchRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the LROBasePolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
        ...
        if cont_token is None:
            raw_result = self._post_route_directions_batch_initial(
                format=format,
                route_directions_batch_request_body=route_directions_batch_request_body,
                cls=lambda x,y,z: x,
                **kwargs
            )
